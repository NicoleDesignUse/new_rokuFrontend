export default {
    ...
    <article>
      ...
      <a href="/#/home"><h2>Back to Main</h2></a>
      ...
      <video src="images/video.mp4">
        ...
        <div class="info">
          ...
          <img :src="movie.image" alt="Free guy movie poster">
        ...
        <div class="movie-detail-content">
          ...
          <div class="meta-wrapper">
            ...
            <div class="badge-wrapper">
              <div class="badge badge-fill">{{movie.contentRating}}</div>
            ...
            <div class="date-time">
              ...
              <div>
                ...
                <time datetime="PT115M">{{movie.runtimeStr}}</time>
              </div>
